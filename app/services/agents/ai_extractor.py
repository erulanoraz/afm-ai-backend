...
"""
AI Extractor 3.2 — улучшенная версия под ChatGPT-style RAG токенизацию.

Главные задачи:
    1. Очистить текст (SUPER PRE-FILTER 3.2)
...
# =====================================================================
# 🔥 SUPER PRE-FILTER 3.2 – аккуратное удаление процессуального мусора
# =====================================================================
...
TECH_MATERIAL = [
    r"допрос окончен.*",
    r"приложени[ея].*",
    # r"протокол допроса.*",  # УБРАНО: содержит важную фабулу
    r"ордер №.*",
    r"дата печати.*",
    r"просмотрено.*",
    r"электронный документ.*",
    r"подпись наложена.*",
    # r"пояснил.*",           # УБРАНО: часто идёт вместе с фабулой
    # r"объяснил.*",          # УБРАНО: часто идёт вместе с фабулой
]
